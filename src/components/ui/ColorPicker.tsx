      ...
      <div className="space-y-3">
        ...
        <div className="flex flex-wrap gap-2">
          {options.map((color) => (
            ...
            >
              {value === color.value && (
                <HiCheck className="w-full h-full text-white drop-shadow-sm" />
              )}
            </button>
          ))}
        </div>
        ...
        {showCustomPicker && (
          <div className="flex items-center space-x-2">
            <div className="relative">
              ...
              >
                <HiEyeDropper className="w-full h-full text-white/80 drop-shadow-sm" />
              </button>
        ...
        {value && (
          <div className="flex items-center space-x-2 pt-2 border-t border-border">
            <HiColorSwatch className="w-4 h-4 text-foreground-muted" />
